...
namespace HousekeeperManager.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var roleExists = await this.roleManager.RoleExistsAsync("Client");

                    if (roleExists)
                    {
                        var resultRoleAdded = await this._userManager.AddToRoleAsync(user, "Client");
